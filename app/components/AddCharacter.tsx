...
import AddCharacterStore, {AddCharacterState} from '../stores/AddCharacterStore';
import AddCharacterActions from '../actions/AddCharacterActions';

class AddCharacter extends React.Component<any, AddCharacterState> {
	...
	handleSubmit(event: any, _fooEvent: any) {
		...
		if (!name) {
			...
			(this.refs as any).nameTextField.getDOMNode().focus();
		}
